...
$app['SERVICE_URL'] = 'sitecake/2.3.6/src/app.php';

// URL relative to sitecake.php that Sitecake editor is using to load the login module
$app['EDITOR_LOGIN_URL'] = 'sitecake/2.3.6/client/publicmanager/publicmanager.nocache.js';

// URL relative to sitecake.php that Sitecake editor is using to load the editor module
$app['EDITOR_EDIT_URL'] = 'sitecake/2.3.6/client/contentmanager/contentmanager.nocache.js';
